...
REGISTER_WINDOW_FUNCTION(max, wf::ExpressionFromAccumulator<AccumulatorMax>::parse);
REGISTER_WINDOW_FUNCTION(min, wf::ExpressionFromAccumulator<AccumulatorMin>::parse);
