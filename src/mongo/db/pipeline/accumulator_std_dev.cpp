...
REGISTER_WINDOW_FUNCTION(stdDevPop, wf::ExpressionFromAccumulator<AccumulatorStdDevPop>::parse);
REGISTER_WINDOW_FUNCTION(stdDevSamp, wf::ExpressionFromAccumulator<AccumulatorStdDevSamp>::parse);
